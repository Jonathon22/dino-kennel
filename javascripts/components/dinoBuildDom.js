...
const buildDino = (item, index) => {
  return ` <div class="card" style="width: 18rem;">
    ...
    <div class="progress">
    <div class="progress-bar progress-bar-striped bg-success" role="progressbar" style="width: ${item.health}%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
  </div>
